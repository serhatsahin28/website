...
-- veritabanı yapısı dökülüyor
CREATE DATABASE IF NOT EXISTS `magazaa` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci */;
USE `magazaa`;

-- tablo yapısı dökülüyor magazaa.anasayfa
...
-- magazaa.anasayfa: 1 rows tablosu için veriler indiriliyor
/*!40000 ALTER TABLE `anasayfa` DISABLE KEYS */;
INSERT INTO `anasayfa` (`id`, `foto`, `ustBaslik`, `ustIcerik`, `link`, `altBaslik`, `altIcerik`) VALUES
	(1, 'intro.jpg', 'Değerli  İçecek', '<p>12U Falan filan Every cup of our quality artisan coffee starts with locally sourced, hand picked ingredients. Once you try it, our coffee will be a blissful addition to your everyday morning routine - we guarantee it!</p>', 'To You', 'To You', '<p>Lorem ipsum</p>');
/*!40000 ALTER TABLE `anasayfa` ENABLE KEYS */;

-- tablo yapısı dökülüyor magazaa.hakkimizda
...
-- magazaa.hakkimizda: 1 rows tablosu için veriler indiriliyor
...
-- tablo yapısı dökülüyor magazaa.iletisim
...
-- magazaa.iletisim: 2 rows tablosu için veriler indiriliyor
...
-- tablo yapısı dökülüyor magazaa.kullanicilar
...
-- magazaa.kullanicilar: 2 rows tablosu için veriler indiriliyor
...
-- tablo yapısı dökülüyor magazaa.magaza
...
-- magazaa.magaza: 1 rows tablosu için veriler indiriliyor
...
-- tablo yapısı dökülüyor magazaa.magazasaat
...
-- magazaa.magazasaat: 7 rows tablosu için veriler indiriliyor
...
-- tablo yapısı dökülüyor magazaa.urunler
...
-- magazaa.urunler: 4 rows tablosu için veriler indiriliyor
